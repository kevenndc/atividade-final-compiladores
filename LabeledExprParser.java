...
public class LabeledExprParser extends Parser {
	...
	public static class PrintStringValContext extends StatContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LabeledExprVisitor ) return ((LabeledExprVisitor<? extends T>)visitor).visitPrintStringVal(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class InitConstantsContext extends StatContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LabeledExprVisitor ) return ((LabeledExprVisitor<? extends T>)visitor).visitInitConstants(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class EvalToStringContext extends Str_valContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LabeledExprVisitor ) return ((LabeledExprVisitor<? extends T>)visitor).visitEvalToString(this);
			else return visitor.visitChildren(this);
		}
	}
